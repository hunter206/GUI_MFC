...
GenApi::IInteger* CGuiSampleDoc::GetIntegerFeature(GenApi::INode* pNode) const
{
    if (pNode == NULL)
    {
        return NULL;
...
GenApi::IInteger* CGuiSampleDoc::GetExposureTime()
{
...
GenApi::IInteger* CGuiSampleDoc::GetGain()
{
    // GenICam smart pointers will throw an exception if you try to access a NULL pointer.
...
GenApi::IEnumeration* CGuiSampleDoc::GetTestImage()
{
    // GenICam smart pointers will throw an exception if you try to access a NULL pointer.
...
GenApi::IEnumeration* CGuiSampleDoc::GetPixelFormat()
{
    // GenICam smart pointers will throw an exception if you try to access a NULL pointer.
...
BOOL CGuiSampleDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
    ...
    try
    {
        ...
        if (m_ptrExposureTime.IsValid())
        {
            ...
            m_hExposureTime = GenApi::Register( m_ptrExposureTime->GetNode(), *this, &CGuiSampleDoc::OnNodeChanged );
        }
        ...
        if (m_ptrGain.IsValid())
        {   // Add a callback that triggers the update.
            m_hGain = GenApi::Register( m_ptrGain->GetNode(), *this, &CGuiSampleDoc::OnNodeChanged );
        }
        ...
        {
            // Add a callback that triggers the update.
            m_hTestimage = GenApi::Register(m_ptrTestimage->GetNode(), *this, &CGuiSampleDoc::OnNodeChanged);
        }
        ...
        {
            // Add a callback that triggers the update.
            m_hPixelformat = GenApi::Register(m_ptrPixelformat->GetNode(), *this, &CGuiSampleDoc::OnNodeChanged);
        }
